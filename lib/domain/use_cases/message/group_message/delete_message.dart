...
class DeleteMessageForGroupChatUseCase implements UseCaseThreeParams<void, String, Message, Message?> {
  ...
  Future<void> call({
    ...
    return _addPostToUserRepository.deleteMessage(
        chatOfGroupUid: paramsOne, messageInfo: paramsTwo, replacedMessage: paramsThree);
  }
}
