...
class PutLikeOnThisCommentUseCase implements UseCaseTwoParams<void, String, String> {
  ...
  Future<void> call({required String paramsOne, required String paramsTwo}) {
    return _putLikeRepository.putLikeOnThisComment(commentId: paramsOne, myPersonalId: paramsTwo);
  }
}
