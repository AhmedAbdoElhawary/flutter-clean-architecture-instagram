...
class RemoveLikeOnThisCommentUseCase implements UseCaseTwoParams<void, String, String> {
  ...
  Future<void> call({required String paramsOne, required String paramsTwo}) {
    return _removeLikeRepository.removeLikeOnThisComment(commentId: paramsOne, myPersonalId: paramsTwo);
  }
}
