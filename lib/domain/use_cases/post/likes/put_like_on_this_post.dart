...
class PutLikeOnThisPostUseCase implements UseCaseTwoParams<void, String, String> {
  ...
  Future<void> call({required String paramsOne, required String paramsTwo}) {
    return _putLikeOnThisPostRepository.putLikeOnThisPost(postId: paramsOne, userId: paramsTwo);
  }
}
