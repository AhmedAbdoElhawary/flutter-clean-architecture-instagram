...
class DeleteTheRoomUseCase extends UseCaseTwoParams<void, String, List<dynamic>> {
  ...
  @override
  Future<void> call({required String paramsOne, required List<dynamic> paramsTwo}) async {
    return _callingRoomsRepo.deleteTheRoom(channelId: paramsOne, usersIds: paramsTwo);
  }
}
