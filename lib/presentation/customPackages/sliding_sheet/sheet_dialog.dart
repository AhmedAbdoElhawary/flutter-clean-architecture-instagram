...
import 'package:instagram/presentation/customPackages/sliding_sheet/sheet.dart';
import 'specs.dart';
...
class SheetExtent {
  ...
  late ValueNotifier<double?> currentExtent2;
  double get currentExtent => currentExtent2.value!;
  set currentExtent(double value) =>
      currentExtent2.value = math.min(value, maxExtent);
...
class SlidingSheetScrollController extends ScrollController {
  ...
  void Function(double) get onPop => sheet.pop;
