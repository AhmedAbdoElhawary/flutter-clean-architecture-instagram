...
class _PopupNewPostState extends State<PopupNewPost> {
  ...
  Future<void> onTapButton(
      UserPersonalInfo personalInfo, UserInfoCubit userCubit, BuildContext builder2context) async {
      ...
      children: [
        ...
        if (createPostButton == CreatePostButton.share) ...[
          Align(
            ...
            child:
                Container(width: double.infinity, height: double.infinity, color: ColorManager.transparent),
          )
        ],
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: GestureDetector(
                              ...
                              child: Container(
                                decoration:
                                    const BoxDecoration(color: ColorManager.black54, shape: BoxShape.circle),
  ...
  Future<void> pickAnotherImage() async {
    ...
    for (final img in image) {
      ...
      SelectedByte byte =
          SelectedByte(isThatImage: true, selectedByte: unitImage, selectedFile: File(img.path));
