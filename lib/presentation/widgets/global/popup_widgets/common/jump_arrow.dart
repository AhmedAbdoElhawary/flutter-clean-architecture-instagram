...
class ArrowJump extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    IconData icon = isThatBack ? Icons.arrow_back_ios_rounded : Icons.arrow_forward_ios_rounded;
      ...
      child: Align(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: makeArrowBigger ? ColorManager.white : ColorManager.transparentGrey,
