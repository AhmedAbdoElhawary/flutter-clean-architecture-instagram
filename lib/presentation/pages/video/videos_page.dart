...
class _HorizontalButtonsState extends State<_HorizontalButtons> {
  ...
  Future<void> goToUserProfile(UserPersonalInfo personalInfo) async {
    ...
    await Go(context).push(page: WhichProfilePage(userId: personalInfo.userId, userName: personalInfo.userName));
...
class _VerticalButtons extends StatefulWidget {
  ...
  const _VerticalButtons({required this.videoInfo, required this.videoPlaying});
