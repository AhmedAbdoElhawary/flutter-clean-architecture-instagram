...
class NotificationCubit extends Cubit<NotificationState> {
  ...
  NotificationCubit(this._createNotificationUseCase, this._getNotificationsUseCase, this._deleteNotificationUseCase)
  ...
  Future<void> getNotifications({required String userId}) async {
    ...
    await _getNotificationsUseCase.call(params: userId).then((List<CustomNotification> notifications) {
  ...
  Future<void> createNotification({required CustomNotification newNotification}) async {
    await _createNotificationUseCase.call(params: newNotification).then((notificationUid) {
  ...
  Future<void> deleteNotification({required NotificationCheck notificationCheck}) async {
